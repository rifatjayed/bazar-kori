...
//             Your order has been fulfilled successfully. Will try to
//             ship it to your door steps as I learn the Gins Cheers
//           </p>
//         </div>

//         <div className="border-t border-b border-gray-200 py-6 mb-8">
//           <h2 className="text-lg font-semibold text-gray-700 mb-4">Continue in Emergency</h2>
...
//             {/* Delivery Code */}
//             <div>
//               <h3 className="text-sm font-medium text-gray-500 mb-1">Delivery Code:</h3>
...
//             <div className="mb-4">
//               <h3 className="font-medium text-gray-700 mb-2">Ordinary Orders A-MA:</h3>
...
//                 <p>{billingDetails.city}, {billingDetails.zip}</p>
