...
//   return (
//     <div
//       className="rounded-2xl flex flex-col justify-center w-full max-w-[237px] h-[500px] text-center bg-cover bg-center text-white mx-auto"
//       style={{
//         backgroundImage: `url(${itemCard})`,
//       }}
//     >
//       <div className="flex flex-col justify-between h-full w-full py-[40px] px-4">
//         <h3 className="text-xl font-semibold mb-2">
//           Bring fresh <br /> vegetables to <br />
//           your home
//         </h3>
